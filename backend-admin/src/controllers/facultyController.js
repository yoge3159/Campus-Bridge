...
export const addFaculty = async (req, res) => {
  try {
    const { name, email, password, subject, subjectId, description, experience, college } =
      req.body;
    ...
    const isExists = await Faculty.findOne({ subjectId });
    if (isExists) {
    ...
    currentCollege.faculties.push(newFaculty._id); 
